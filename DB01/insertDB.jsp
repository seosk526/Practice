...
<form method='post' action='inputForm1.html'>
  ...
  <table cellspacing=1 width=400 border=1>
    <tr>
      ...
      <td width=300>
        <p align=center>
          <input type='text' name='name' maxlength="10" value='<%=cTmp%>' readonly>
        </p>
      </td>
    </tr>
    <tr>
      ...
      <td width=300>
        <p align=center>
          <input type='text' name='studentid' value='<%=Integer.toString(NewStdId)%>' readonly>
        </p>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td width=300>
        <p align=center>
          <input type='text' name='english' value='<%=request.getParameter("english")%>' readonly>
        </p>
      </td>
    </tr>
    <tr>
      ...
      <td width=300>
        <p align=center>
          <input type='text' name='mathmatic' value='<%=request.getParameter("mathmatic")%>' readonly>
        </p>
      </td>
    </tr>
  </table>
