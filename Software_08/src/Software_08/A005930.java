...
public class A005930 {
	...
	public static void main(String[] args) throws IOException {
		...
		while ((k01_readtxt = k01_br.readLine()) != null) {						// br에 k01_readtxt안 내용이 아무것도 없지 않다면
			...
			if (k01_field[2].equals("A005930")) {								// k01_field[2] 항목이 A005930이라면
		...
		System.out.printf("A005930 [%d] records\n", k01_cnt);		// A005930 [k01_cnt]records 출력 후 줄바꿈		
	}
}
