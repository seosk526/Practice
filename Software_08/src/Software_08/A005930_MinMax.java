...
public class A005930_MinMax {
	...
	public static void main(String[] args) throws IOException {
		...
		File k01_f = new File("C:\\Users\\강세영\\Desktop\\A005930.csv"); 			// 파일 저장 위치 설정
		...
		String k01_minDate = null;													// 주가 최소값 날짜 변수
		String k01_maxDate = null;													// 주가 최대값 날짜 변수
		...
		while ((k01_readtxt = k01_br.readLine()) != null) { 						// k01_br에 k01_readtxt안 내용이 아무것도 없지 않다면
			...
			if (k01_field[1].contains("2015")) { 									// k01_field[1] 항목에 2015가 포함된다면
				...
				if (k01_min > k01_stockPrice) {							// 최소값 변수보다 k01_stockPrice가 작다면
					...
					k01_minDate = k01_field[1];
				} else if (k01_max < k01_stockPrice) {					// 최대값 변수보다 k01_stockPrice가 크다면
					k01_max = k01_stockPrice;							// 최대값 변수에 k01_stockPrice 대입
					k01_maxDate = k01_field[1];
				}
			}
		}
		k01_br.close(); 														// BufferedReader 클래스 종료
		System.out.printf("삼성전자 주가 최소값 날짜 : %s\n", k01_minDate);		// 삼성전자 주가 최소값 날짜 : k01_minDate 출력
		System.out.printf("삼성전자 주가 최소값 : %d\n", k01_min);				// 삼성전자 주가 최소값 : k01_min 출력
		System.out.printf("삼성전자 주가 최대값 날짜 : %s\n", k01_maxDate);		// 삼성전자 주가 최대값 날짜 : k01_maxDate 출력
		System.out.printf("삼성전자 주가 최대값 : %d\n", k01_max);				// 삼성전자 주가 최대값 : k01_max 출력
	}		
}
